  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="w-full relative h-75 md:h-112.5 flex flex-col items-center justify-center text-center rounded-3xl overflow-hidden mb-12 shadow-2xl"
      >
        ...
        <div className="relative z-10 px-6 ">
          ...
          <motion.p
            variants={itemVariants}
            className="text-gray-100 text-lg md:text-xl max-w-2xl mx-auto drop-shadow-md"
          >
      ...
      <motion.div
        variants={itemVariants}
        className="flex w-full justify-center gap-4 mb-10"
      >
